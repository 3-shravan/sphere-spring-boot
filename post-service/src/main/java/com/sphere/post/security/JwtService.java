...
/**
 * Verification-only mirror of user-service's JwtService — post-service
 * never issues tokens, only validates them (stateless JWT, shared
 * JWT_SECRET across services, per docs/02-target-architecture.md).
 */
@Service
