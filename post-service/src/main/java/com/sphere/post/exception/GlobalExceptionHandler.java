...
import com.sphere.post.dto.response.ErrorResponse.ValidationErrorDetail;
...
/**
 * Production-grade Centralized Exception Handler for post-service.
 * Handles validation, business exceptions, framework errors, and unexpected faults.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest request) {
        ...
        return respond(HttpStatus.CONFLICT, ErrorType.Conflict.name(), "Database integrity violation (duplicate entry or constraint conflict)", request, traceId, null);
    }
